...
{
    public class CSVReaderHelper:IDisposable
    {
        ...
        public CSVReaderHelper(FileInfo csvFileInfo)
        {
            if (csvFileInfo == null)
        ...
        public CSVReaderHelper(string csvData)
        {
            if (csvData == null)
        ...
        public CSVReaderHelper(TextReader reader)
        {
            if (reader == null)
